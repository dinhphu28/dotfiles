...
augroup spelunker
  ...
  autocmd BufWinEnter,BufWritePost *.vim,*.js,*.jsx,*.json,*.md,*.scala call spelunker#check()
...
-- local error_color = vim.fn.synIDattr(vim.fn.hlID("Comment"), "fg")
local error_color = "#335500"
